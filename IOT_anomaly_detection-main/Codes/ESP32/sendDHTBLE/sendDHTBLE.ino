...
#define bleServerName       "ESP32Server" 
 
#define DHT_PIN 4    // Pin to which DHT11/DHT22 data pin is connected 
#define DHT_TYPE DHT22 // Change to DHT22 if you are using DHT22 sensor 
